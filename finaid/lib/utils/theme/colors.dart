...
class ThemeColors{
  static const MaterialColor info = MaterialColor(_successPrimaryValue, <int, Color>{
    50: Color(0xFFE2F4EA),
  ...
  static const MaterialColor infoAccentt = MaterialColor(_successAccentValue, <int, Color>{
  ...
  static const MaterialColor success = MaterialColor(_infoPrimaryValue, <int, Color>{
    50: Color(0xFFE1EFFA),
  ...
  static const MaterialColor successAccent = MaterialColor(_infoAccentValue, <int, Color>{

  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Hi! welcome to FinAid", style: theme.textTheme.headlineMedium!.apply(color: theme.colorScheme.primary, fontWeightDelta: 1),),
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Row(
          children: <Widget>[Text("Continue"), SizedBox(width: 10,), Icon(Icons.arrow_forward)],
        ),
      ),
    );
  }
